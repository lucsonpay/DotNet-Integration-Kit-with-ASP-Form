...
<tr>
	...
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_EMAIL" name="CUST_EMAIL" value="yourpg@gmail.in" /></td>
</tr>
<tr>	
	<td width="50%" align="right" valign="middle">Phone</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_PHONE" name="CUST_PHONE" value="843945xxxx" /> </td>
</tr>
...
<tr>
	<td width="50%" align="right" valign="middle">Email</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_EMAIL" name="CUST_SHIP_EMAIL" value="yourpg@gmail.in" /></td>
</tr>
<tr>	
	<td width="50%" align="right" valign="middle">Phone</td>
	<td width="50%" align="center" valign="middle"><input type="text" id="CUST_SHIP_PHONE" name="CUST_SHIP_PHONE" value="8439452XXX" /> </td>
</tr>
<tr>
